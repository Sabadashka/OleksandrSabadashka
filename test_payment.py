...
class TestPayment_Getter(unittest.TestCase):
    ...
    def test_get_request_date(self):
        self.assertEqual(self.payment.get_payment_request_date(), basedata_valid_attr[0][map_attr[5]])


    def test_get_due_to_date(self):
        self.assertEqual(self.payment.get_payment_due_to_date(), basedata_valid_attr[0][map_attr[6]])
...
class TestPayment_Setter(unittest.TestCase):
    ...
    def test_set_request_date(self):
        self.assertEqual(self.payment.get_payment_request_date(), basedata_valid_attr[0][map_attr[5]])
        self.payment.set_payment_request_date(basedata_valid_attr[1][map_attr[5]])
        self.assertEqual(self.payment.get_payment_request_date(), basedata_valid_attr[1][map_attr[5]])


    def test_set_due_to_date(self):
        self.assertEqual(self.payment.get_payment_due_to_date(), basedata_valid_attr[0][map_attr[6]])
        self.payment.set_payment_due_to_date(basedata_valid_attr[1][map_attr[6]])
        self.assertEqual(self.payment.get_payment_due_to_date(), basedata_valid_attr[1][map_attr[6]])
